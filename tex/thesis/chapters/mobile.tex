...
the general feasibility of the task at hand. It became quite apparrent early on that the desired
...
basically being in standby. On \textit{Android} this can be realized easily with a so called
...
\begin{itemize}
  ...
  \item \textit{CPU} shows the amount of cores available and the frequency they are currently
  ...
  \item \textit{Settings} gives the user the ability to modify the interval of sending data to the
